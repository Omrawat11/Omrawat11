...
- 🔭 Currently building **CivicIQ** — an autonomous civic incident intelligence system with a multi-agent architecture
...
class OmRawat:
    def __init__(self):
        ...
        self.frameworks  = ["TensorFlow", "PyTorch", "Scikit-Learn", "FastAPI", "Streamlit"]
        self.data_tools  = ["Pandas", "NumPy", "Matplotlib", "Seaborn", "Power BI"]
        self.databases   = ["MySQL"]
        self.dev_tools   = ["Git", "GitHub", "VS Code", "Anaconda", "Jupyter Notebook"]

        self.currently_learning = [
            "Deep Learning", "Computer Vision", "NLP",
            "MLOps", "LangChain", "LangGraph"
        ]
...
Cosine-similarity-driven recommendation engine with a vanilla JS frontend, pulling live metadata from the OMDb API.
